   ...
   #pragma omp parallel
{
    ...
    {
       #pragma omp section
         (void)iteracion(2000900,fptr);//20//2000900
       #pragma omp section
         (void)iteracion(2000400,fptr1);//200//2000400
       #pragma omp section
         (void)iteracion(2000700,fptr2);//2000//2000700
       #pragma omp section
         (void)iteracion(2000800,fptr3);//20000//2000800
       #pragma omp section
         (void)iteracion(2000500,fptr4);//200000//2000500
       #pragma omp section
         (void)iteracion(2000100,fptr5);//2000000//2000100
   }
}
